...
public static partial class EnvInfoReflection {
  ...
  static EnvInfoReflection() {
    byte[] descriptorData = global::System.Convert.FromBase64String(
        string.Concat(
          "Cg1FbnZJbmZvLnByb3RvInwKB0VudkluZm8SKQoLbmV0d29ya1R5cGUYASAB",
          "KA4yFC5FbnZJbmZvLk5ldHdvcmtUeXBlEg8KB2FwcE5hbWUYAiABKAwiNQoL",
          "TmV0d29ya1R5cGUSDAoIa0ludmFsaWQQABIJCgVrV0lGSRABEg0KCWtDZWxs",
          "dWxhchACYgZwcm90bzM="));
    descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
        new pbr::FileDescriptor[] { },
        new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
          new pbr::GeneratedClrTypeInfo(typeof(global::EnvInfo), global::EnvInfo.Parser, new[]{ "NetworkType", "AppName" }, null, new[]{ typeof(global::EnvInfo.Types.NetworkType) }, null, null)
        }));
  }
  #endregion
...
public sealed partial class EnvInfo : pb::IMessage<EnvInfo> {
  ...
  public static pbr::MessageDescriptor Descriptor {
    get { return global::EnvInfoReflection.Descriptor.MessageTypes[0]; }
  }
  ...
  private global::EnvInfo.Types.NetworkType networkType_ = global::EnvInfo.Types.NetworkType.KInvalid;
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
  public global::EnvInfo.Types.NetworkType NetworkType {
  ...
  public override int GetHashCode() {
    int hash = 1;
    if (NetworkType != global::EnvInfo.Types.NetworkType.KInvalid) hash ^= NetworkType.GetHashCode();
  ...
  public void WriteTo(pb::CodedOutputStream output) {
    if (NetworkType != global::EnvInfo.Types.NetworkType.KInvalid) {
  ...
  public void MergeFrom(EnvInfo other) {
    ...
    if (other.NetworkType != global::EnvInfo.Types.NetworkType.KInvalid) {
    ...
    while ((tag = input.ReadTag()) != 0) {
      switch(tag) {
        default:
          ...
          break;
        case 8: {
          NetworkType = (global::EnvInfo.Types.NetworkType) input.ReadEnum();
          break;
        }
        case 18: {
